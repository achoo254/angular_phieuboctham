...
module.exports = __webpack_require__(/*! F:\GitHub\uploads\phieuboctham\src\main.ts */"zUnb");
...
InphieuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: InphieuComponent, selectors: [["app-inphieu"]], decls: 1, vars: 1, consts: [[4, "ngFor", "ngForOf"], [1, "row"], [1, "col-sm-4"], [1, "card"], [1, "border-bottom", 2, "height", "65px", "padding", "10px"], [1, "card-title", "text-center", "font-weight-bold"], [1, "border-bottom", 2, "height", "30px"], [1, "card-text", "font-italic", "text-center"], [1, "border-bottom", 2, "height", "45px", "padding", "10px"], [1, "card-text", "font-italic"], [1, "font-weight-bold"], [1, "", 2, "height", "90px", "padding", "20px"], [1, "card-text", "font-weight-bold", "text-center"]], template: function InphieuComponent_Template(rf, ctx) { if (rf & 1) {
